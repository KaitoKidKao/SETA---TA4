...
export function analyzeSkillGaps(jobTitle: string): SkillGapInfo {
  ...
  try {
    ...
    // 2. Read Hire Requests to extract raw gap summaries
    ...
    // Identify weak or missing skills (Intermediate or Basic)
