...
- Bachelor's degree in Computer Science, Mathematics, or related fields.`);
  ...
  const skillGapsQuery = useSkillGaps(criteriaDetailsQuery.data?.job_title ?? '', criteriaIdToLoad);
                            ...
                            <>
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                <div className="bg-emerald-500/5 border border-emerald-500/10 rounded-xl p-2.5 flex flex-col gap-2">
                                  ...
                                  <div className="flex flex-col gap-1.5">
                                    {(skillGaps.structuredRecommendations ?? []).filter(
                                      (gap: any) => gap.applied,
                                    ).length > 0 ? (
                                      (skillGaps.structuredRecommendations ?? [])
                                        .filter((gap: any) => gap.applied)
                              ...
                              {skillGaps.recommendations.length > 0 && (
                                <div className="text-body-sm text-ink flex flex-col gap-1 mt-1 border-t border-blue-500/10 pt-2.5">
